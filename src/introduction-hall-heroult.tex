...
\fig{electrolysis-pot}. Le bain électrolytique (voir
fig. \ref{fig:electrolysis-pot}.m), dont le rôle est de permettre la
dissociation des ions \ce{Al^{3+}} et \ce{O^{2-}} nécessaire à la
...
% conclusion: sur quel aspect va porter le travail
