...
des mailles dans le plan $(x,y)$ des deux calculs (Stokes-Fourier et méthode 3D standard)
...
interviennent dans ce modèle ont déjà été introduites dans la table
