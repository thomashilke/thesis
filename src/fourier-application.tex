  ...
  \begin{center}
    ...
    \begin{tikzpicture}
      \begin{axis}[
          ...
          point meta max=6.0,
          colorbar style={
            title=Vitesse $u_{h,K}^\mathrm{SF}$ [\si{\centi\meter\per\second}],
            width=7.4cm,
            height=0.3cm,
            xtick={0.0, 3.0, 6.0},
            at={(0.5\rasterimagewidth,0.4cm)},
...
conductivité électrique quasi-nulle initialement, augmente au fur
...
chapitre \ref{chap:dissolution} par l'abréviation F3D. Dans cette
...
désactivant la dépendance de la vitesse de dissolution par rapport
...
\begin{figure}
  \begin{center}
    %\input{../media/fourier/anode-deactivation/anode-deactivation.tex}
...
% comparaison side-by-side entre la vitesse d'ecoulement stationnaire
% et la concentration stationnaire avec le modele Full3D.
\begin{figure}
  \begin{center}
    \begin{subfigure}[t]{0.49\textwidth}
      \begin{center}
        \includegraphics[width=0.9\textwidth]{../media/fourier/application/print/ab-0-1-velocity-acd.png}     \includegraphics[width=0.9\textwidth]{../media/fourier/application/print/ab-0-2-velocity-acd.png}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
      \begin{center}
            \includegraphics[width=0.99\textwidth]{../media/fourier/application/print/ab-0-1-concentration-acd.png}     \includegraphics[width=0.99\textwidth]{../media/fourier/application/print/ab-0-2-concentration-acd.png}
...
% Comparaison entre les schemas numerique pour la vitesse d'ecoulement stationnaire
\begin{figure}
  \begin{center}
    \begin{subfigure}[t]{0.49\textwidth}
      \begin{center}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
      \begin{center}
        \includegraphics[width=0.99\textwidth]{../media/fourier/application/print/ab-0-1-velocity-harm.png}
        \includegraphics[width=0.99\textwidth]{../media/fourier/application/print/ab-0-2-velocity-harm.png}
        \includegraphics[width=0.99\textwidth]{../media/fourier/application/print/ab-1-1-velocity-harm.png}
        \includegraphics[width=0.99\textwidth]{../media/fourier/application/print/ab-1-2-velocity-harm.png}
        \begin{tikzpicture}
          \begin{axis}[
              colorbar,
              hide axis,
...
% Comparaison entre les schema numerique de concentration
\begin{figure}
  \begin{center}
    \begin{subfigure}[t]{0.49\textwidth}
      \begin{center}
...
% Comparaison entre les schema numerique de concentration, FC
\begin{figure}
  \begin{center}
    \begin{subfigure}[t]{0.49\textwidth}
      \begin{center}
