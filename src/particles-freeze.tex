...
Un certain nombre de solutions exactes du problème de Stefan
...
\begin{figure}[h]
  \begin{center}
    ...
    \caption{Erreur $L^2$ entre la solution exacte de Neumann et
      l'approximation numérique $\temperature^N_\delta$. Pour ce
...
selon les simulations de V. Dassylva-Raymond \cite{Dassylva2015}, on
