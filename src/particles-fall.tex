...
%%\begin{remarque}
%%  On considère finalement une particule d'alumine de rayon $r_0$
%%  supposé constant au cours du temps, et soumise à la force de
%%  gravité $\gravityforce$ et d'Archimède $\buoyancyforce$. Alors
%%  l'équation du mouvement (\ref{eq:mvt}) se résoud à nouveau exactement,
%%  et la vitesse de la particule au cours du temps s'écrit
%%  \begin{equation}
%%    \dot x(t) =\frac{2r_0^2\parent{\aluminadensity -
%%        \electrolytedensity} g}{9\electrolyteviscosity}\parent{1 -
%%      \exp\parent{-\frac{9\electrolyteviscosity}{2\aluminadensity r_0^2}t}}
%%  \end{equation}
%%  et donc
%%  \begin{equation}
%%    \lim_{t\to\infty}\dot x(t) = \frac{2r_0^2\parent{\aluminadensity -
%%    \electrolytedensity} g}{9\electrolyteviscosity}
%%  \end{equation}
%%\end{remarque}
