...
d'aluminium développées par ce groupe, en particulier par S. Pain
\cite{Pain2006}, G. Steiner \cite{Steiner2009}, J. Rochat
\cite{Rochat2016} et T. Hofer \cite{Hofer2011}, et qui sont toutes
implémentées avec \alucell{}. Un historique détaillé se trouve dans la
thèse de G. Steiner \cite{Steiner2009}. Par conséquent utiliserons
également \alucell{} pour l'implémentation des méthodes numériques
dans ce chapitre.
