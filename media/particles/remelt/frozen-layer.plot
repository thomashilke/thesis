...
set ylabel "Rayon du volume gel\\'e $R_f$ [\\si{\\micro\\meter}]"

set output 'frozen-layer-sur10.tex'

set title 'Surchauffe du bain $\telectrolyte - \tliq = 10$\si{\kelvin}'
...
set title 'Surchauffe du bain $\telectrolyte - \tliq = 5$\si{\kelvin}'
...
set title 'Surchauffe du bain $\telectrolyte - \tliq = 2.5$\si{\kelvin}'
